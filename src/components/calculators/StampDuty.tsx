            ...
            {STATES.map((st) => {
              ...
              return (
                <button
                  ...
                  aria-pressed={active}
                  className={`inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full md:rounded-md border px-4 text-[13px] font-semibold transition-colors ${
                    active
